...
class DataItemDetails: DataItemDetailsProtocol {
    ...
    init(name: String, model: String, manufacturer: String, costInCredits: String, length: String, mglt: String, crew: String, passengers: String, cargoCapacity: String, consumables: String, className: String) {
        self.name = name
        self.model = model
